...
# Click Kaydet at (1610, 995)
print("Clicking Kaydet at (1610, 995)...")
user32.SetCursorPos(1610, 995)
time.sleep(0.1)
...
time.sleep(4.0)
img = ImageGrab.grab()
out_path = r"C:\Users\Asus\.gemini\antigravity\brain\b3555101-a26c-4830-8426-867ed4aa4195\cname_saved_confirmed.png"
img.save(out_path)
print("Saved confirmation screenshot to:", out_path)
