      ...
      output: {
        codeSplitting: {
          groups: [
            ...
            {
              name: "tymm-planning-core",
              test: /src[\\/]features[\\/]official-forms[\\/](?:tymm-domain-chips|ek15-catalog|TYMMPlanHub|SmartDailyPlanWizard|MEBOfficialSkillsPortal)\.(?:ts|tsx)$/,
              priority: 90,
            },
            {
