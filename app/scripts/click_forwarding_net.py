...
# Click "Yönlendirme" tab around (365, 395)
print("Clicking 'Yönlendirme' tab at (365, 395)...")
user32.SetCursorPos(365, 395)
time.sleep(0.1)
...
time.sleep(2.0)
img = ImageGrab.grab()
out_path = r"C:\Users\Asus\.gemini\antigravity\brain\b3555101-a26c-4830-8426-867ed4aa4195\forwarding_tab.png"
img.save(out_path)
print("Saved forwarding tab screenshot to:", out_path)
