...
test("IndexedDB v6 değer kanıtı ile plan/etkinlik gözlem indekslerini tanımlar", () => {
  assert.equal(MAARIFOS_DATABASE_VERSION, 6);
  assert.equal(INDEXED_DB_MIGRATIONS.at(-1)?.toVersion, 6);
  assert.deepEqual(
