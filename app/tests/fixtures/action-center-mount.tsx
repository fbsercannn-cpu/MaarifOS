...
export async function mountActionCenter(options: { disabled?: boolean; failRefreshAfterCommit?: boolean; preparation?: boolean; refreshOnFollowup?: boolean; deferredRefreshMs?: number } = {}) {
