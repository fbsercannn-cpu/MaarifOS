...
export function MaarifApiConfigModal({ isOpen, onClose, onSaved }: Props) {
  const [provider, setProvider] = useState<SupportedAIProvider>("local");
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", gap: 10, flexWrap: "wrap" }}>
          ...
          <button type="button" onClick={save} style={{ padding: "9px 16px", borderRadius: 8, border: 0, background: "#0284c7", color: "#fff", fontWeight: 700 }}>
            Kaydet
          </button>
        </div>
      </section>
