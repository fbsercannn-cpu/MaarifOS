...
# Click "Yönlendirme" tab at (700, 405)
print("Clicking Yönlendirme tab at (700, 405)...")
user32.SetCursorPos(700, 405)
time.sleep(0.1)
...
time.sleep(2.0)
img = ImageGrab.grab()
out_path = r"C:\Users\Asus\.gemini\antigravity\brain\b3555101-a26c-4830-8426-867ed4aa4195\yonlendirme_opened.png"
img.save(out_path)
