...
Program bağlantısı öğretmen tarafından doğrulanmış gözlem, haftalık değerlendirme ve veli bülteni için iki düzenlenebilir taslak üretebilir. DeepSeek isteğinden önce bilinen çocuk/yakın adları ve doğrudan iletişim kimlikleri çıkarılır; sağlık, aile veya adres riski taşıyan ham metin buluta gönderilmez. Sağlayıcı yanıtı iki alanlı JSON, uzunluk, kişisel veri ve pedagojik hüküm kapılarından geçer. Sonuç hiçbir zaman otomatik kayıt değildir: öğretmen iki metni görür, düzenler ve açık kayıt düğmesiyle aynı yerel işlemde kaydeder. Kaynak gözlem değişirse eski taslak reddedilir; sağlayıcı kullanılamazsa cihaz içi taslak korunur.
